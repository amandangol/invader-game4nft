...
function preload() {
    alienImages = loadImage("assets/ufo.png");  // Load the first alien image
    shooterImage = loadImage('assets/spaceship.png');
    upgradedShooterImage = loadImage('assets/spaceship2.png');
    fourthUpgradedShooterImage = loadImage('assets/spaceship3.png');
